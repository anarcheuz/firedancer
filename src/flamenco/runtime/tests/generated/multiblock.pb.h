...
typedef struct org_solana_sealevel_v1_block_step {
    ...
    /* Optional restore-style reward recalculation before pre-exec. */
    bool restore_partitioned_rewards;
...
#define ORG_SOLANA_SEALEVEL_V1_BLOCK_STEP_INIT_ZERO {0, NULL, 0, NULL, 0, 0, {{NULL}, NULL}, false, ORG_SOLANA_SEALEVEL_V1_FEATURE_SET_INIT_ZERO, false, ORG_SOLANA_SEALEVEL_V1_INFLATION_INIT_ZERO, false, ORG_SOLANA_SEALEVEL_V1_FEE_RATE_GOVERNOR_INIT_ZERO, 0, false, ORG_SOLANA_SEALEVEL_V1_SYNTHETIC_FRONTIER_PREFIX_INIT_ZERO, 0}
...
#define ORG_SOLANA_SEALEVEL_V1_BLOCK_STEP_RESTORE_PARTITIONED_REWARDS_TAG 11
...
X(a, STATIC,   SINGULAR, BOOL,     restore_partitioned_rewards,  11)
